import{a as e,n as t,t as n}from"./reveal-C5xMytDG.js";import"./three.module-DCYiBNzM.js";import"./portfolio-bg-Ba5YbJyk.js";function r(e){return!e||e.length===0?``:`<div class="post-tags">${e.map(e=>`<span class="gallery-card-tag">${e}</span>`).join(``)}</div>`}function i(e,n){return`
