import"./three.module-DmW5sRKN.js";import"./portfolio-bg-Cj21Sz36.js";var e=[{title:`Shaders Reel 2026`,tag:[`Showreel`,`GLSL`,`VFX`],type:`video`,src:`/projects/reel-2026.mp4`,poster:`/projects/reel-2026.jpg`,description:`Recent shader based fx (GLSL)`},{title:`GAMEDEV VFX`,tag:[`Gamedev`,`Unity`,`VFX`],type:`video`,src:`/projects/unity-vfx1.mp4`,poster:`/projects/unity-vfx1.jpg`,description:`Unity VFX Practice reel 2022`}];function t(e){return e?(Array.isArray(e)?e:[e]).map(e=>`<span class="gallery-card-tag">${e}</span>`).join(``):``}function n(e){if(e.type===`video`){let t=e.poster?` poster="${e.poster}"`:``;return`<video src="${e.src}"${t} muted loop autoplay playsinline preload="metadata"></video>`}return`<img src="${e.src}" alt="${e.title}" loading="lazy" />`}function r(e,r){return`
