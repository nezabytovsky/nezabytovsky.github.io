import{F as e,W as t,a as n,et as r,o as i,s as a}from"./three.module-DYuz7n-v.js";function o(e=[[0,1],[.1,.9],[.4,.5],[.7,.1],[1,0]]){let t=document.createElement(`canvas`);t.width=t.height=64;let n=t.getContext(`2d`),r=n.createRadialGradient(32,32,0,32,32,32);for(let[t,n]of e)r.addColorStop(t,`rgba(255,255,255,${n})`);return n.fillStyle=r,n.fillRect(0,0,64,64),new a(t)}var s=`
