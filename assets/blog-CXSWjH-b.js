import{a as e,n as t,t as n}from"./reveal-C5xMytDG.js";import"./three.module-Cs8GzSxb.js";import"./portfolio-bg-G3Kdc9KR.js";function r(e){return!e||e.length===0?``:`<div class="post-tags">${e.map(e=>`<span class="gallery-card-tag">${e}</span>`).join(``)}</div>`}function i(e,n){return`
