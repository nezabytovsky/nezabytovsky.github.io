import{a as e,n as t,t as n}from"./reveal-3CbbLd40.js";import"./three.module-DYuz7n-v.js";import"./portfolio-bg-BJQuwpMB.js";function r(e){return!e||e.length===0?``:`<div class="post-tags">${e.map(e=>`<span class="gallery-card-tag">${e}</span>`).join(``)}</div>`}function i(e,n){return`
